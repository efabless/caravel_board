...
#define CSR_LA_IEN_SIZE 2
static inline uint64_t la_ien_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 12288L);
	r <<= 32;
	r |= csr_read_simple(CSR_BASE + 0x3004L);
	return r;
}
static inline void la_ien_write(uint64_t v) {
	csr_write_simple(v >> 32, CSR_BASE + 0x3000L);
	csr_write_simple(v, CSR_BASE + 0x3004L);
}
#define CSR_LA_OE_ADDR (CSR_BASE + 0x3008L)
#define CSR_LA_OE_SIZE 2
static inline uint64_t la_oe_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 12296L);
	r <<= 32;
	r |= csr_read_simple(CSR_BASE + 0x300cL);
	return r;
}
static inline void la_oe_write(uint64_t v) {
	csr_write_simple(v >> 32, CSR_BASE + 0x3008L);
	csr_write_simple(v, CSR_BASE + 0x300cL);
}
#define CSR_LA_IN_ADDR (CSR_BASE + 0x3010L)
#define CSR_LA_IN_SIZE 2
static inline uint64_t la_in_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 12304L);
	r <<= 32;
	r |= csr_read_simple(CSR_BASE + 0x3014L);
	return r;
}
#define CSR_LA_OUT_ADDR (CSR_BASE + 0x3018L)
#define CSR_LA_OUT_SIZE 2
static inline uint64_t la_out_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 12312L);
	r <<= 32;
	r |= csr_read_simple(CSR_BASE + 0x301cL);
	return r;
}
static inline void la_out_write(uint64_t v) {
	csr_write_simple(v >> 32, CSR_BASE + 0x3018L);
